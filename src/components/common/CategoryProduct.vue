<template>
  <div>
    <el-card class="box-card">
      ...
      <el-form :inline="true" style="padding: 18px" ref="AddCategoryForm" :model="AddCategoryForm"  >
        <el-form-item label="添加类别" prop="AddCategoryName">
          <el-input placeholder="类别名称" v-model="AddCategoryForm.AddCategoryName" ></el-input>
        </el-form-item>
        <el-form-item label="类别类型" prop="AddCategoryCode">
  ...
  <el-table
    ...
    border
    style="width: 100%">
    <el-table-column prop="categoryId" label="类别ID" width="90px" :index="categoryId">
    </el-table-column>
...
<script>
    export default {
      ...
      methods:{
        ...
        addCategory(){
          if (this.AddCategoryForm.AddCategoryName==null||this.AddCategoryForm.AddCategoryCode==null) {
